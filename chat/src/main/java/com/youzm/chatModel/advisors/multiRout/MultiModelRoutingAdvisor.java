...
@Component
public class MultiModelRoutingAdvisor implements CallAdvisor, StreamAdvisor  {
...
//    private static final int ORDER = Ordered.HIGHEST_PRECEDENCE + 10;
    ...
    public ChatClientResponse adviseCall(ChatClientRequest advisedRequest, CallAdvisorChain chain) {
        try {
            ...
            ChatResponse chatResponse = selectedModel.call(advisedRequest.prompt());
    ...
    public Flux<ChatClientResponse> adviseStream(ChatClientRequest request, StreamAdvisorChain chain){
        ...
        Flux<ChatResponse> responseFlux = selectedModel.stream(request.prompt());
        return responseFlux.map(response -> ChatClientResponse.builder()
    ...
    public String extractUserQuery(ChatClientRequest request) {
