...
public class ModelConfig {
    ...
    public ChatModel zhipuChatModel() {
        ZhiPuAiApi zhiPuAiApi = ZhiPuAiApi.builder().apiKey(zhipuApiKey).build();
    ...
    // DeepSeek 模型（集成工具调用）
    @Bean("deepseekModel")
    public ChatModel deepseekModel(ToolService toolService) {
...
//        // 将 ToolService 转换为 ToolCallback 数组
    ...
    public ChatClient chatClient(ChatClient.Builder builder,
                                 MultiModelRoutingAdvisor routingAdvisor,
